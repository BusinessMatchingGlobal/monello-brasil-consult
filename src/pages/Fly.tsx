...
const copy: Record<UILang, Copy> = {
  ...
  en: {
    ...
    tripOneway: "One way",
    tripComplex: "Multi-city",
    outbound: "Outbound",
    return: "Return",
    leg: "Leg",
    addLeg: "Add leg",
    removeLeg: "Remove",
    origin: "From (departure airport)",
    destination: "To (arrival airport)",
    viewMap: "View on map",
    date: "Date",
    ...
    passengerAttention: "Please take extra care when entering FIRST and LAST NAME: they must match exactly what appears on the passport that will be used for the trip.",
    passenger: "Passenger",
    ...
    classBusiness: "Business",
    bags: "Checked bags",
    weight: "Baggage allowance (per piece)",
    ...
    passengerAttentionLead: "Please take extra care when entering FIRST and LAST NAME: they must match ",
    passengerAttentionMid1: "",
    passengerAttentionEmph: "exactly",
    passengerAttentionMid2: " what appears on the passport that will be used for the trip. The ticket is issued with these details — even a single-letter error may require reissue, and the original fare may no longer be available.",
    passengerAttentionTail: "",
    ...
    responsibilityAck: "I choose not to send the documents. I confirm that the data provided matches exactly the documents that will be used for the trip, and I acknowledge that any reissue costs or refusal of carriage resulting from discrepancies will be my sole responsibility.",
  ...
  es: {
    ...
    passengerAttention: "Preste especial atención al ingresar NOMBRE y APELLIDO: deben coincidir exactamente con lo que figura en el pasaporte que se utilizará para el viaje.",
    passenger: "Pasajero",
    ...
    notesPlaceholder: "Indique cualquier dato que considere útil (necesidades especiales, preferencias de horario, pedidos especiales, etc.).",
    servicesTitle: "Otros servicios solicitados",
    servicesIntro: "También podemos ofrecerle, con tarifas negociadas con nuestros proveedores: hoteles, traslados privados o compartidos, alquiler de autos, atracciones y excursiones, y seguro de viaje. Si tiene preferencias, indique zona o nombre del hotel, fechas y — si lo tiene — el mejor precio que haya encontrado: intentaremos presentarle nuestra mejor oferta.",
    ...
    passengerAttentionLead: "Preste especial atención al ingresar NOMBRE y APELLIDO: deben coincidir ",
    passengerAttentionMid1: "",
    passengerAttentionEmph: "exactamente",
    passengerAttentionMid2: " con lo que figura en el pasaporte que se utilizará para el viaje. El pasaje se emite con estos datos — un error de una sola letra puede obligar a reemitirlo, y la tarifa original podría ya no estar disponible.",
    passengerAttentionTail: "",
    docsTitle: "Adjuntar copia de los documentos (opcional, pero muy recomendable)",
    docsIntro: "Adjunte el pasaporte y/o el documento de residencia (por ejemplo, CRNM/RNE en Brasil, DNI o equivalente). No es obligatorio — pero es la forma más simple de proteger su tarifa: nuestro equipo verifica nombre, número y vigencia antes de emitir.",
    passportLabel: "Pasaporte — página de identificación",
    passportHelp: "Foto o escaneo donde se vean con claridad nombre y apellido, número del documento, fecha de emisión y fecha de vencimiento. La imagen debe estar nítida, completa y sin reflejos.",
