...
const body: Block[] = [
  ...
  { p: `Os números da petição: R$ 17,3 bilhões em passivos, dos quais cerca de R$ 16,4 bilhões com credores quirografários, além de R$ 754 milhões em dívidas trabalhistas e R$ 154 milhões com micro e pequenas empresas. Na abertura de segunda, BHIA3 caiu até R$ 0,45 — quase 32% às 10h28, cerca de 36% no pior momento — sobre uma queda de quase 80% no ano. A auditoria já havia apontado incerteza relevante sobre a continuidade operacional.` },
  { p: `Há um detalhe técnico na petição que explica o timing melhor do que qualquer um desses números. Os contratos do grupo carregam cláusulas de cross-default e vencimento antecipado, pelas quais a notícia de uma reorganização poderia tornar tudo exigível de uma vez, junto com execução de garantias e cobranças antecipadas. O pedido existe para congelar essa cascata antes que ela comece. O que reenquadra o evento inteiro: a companhia não protocolou porque parou de gerar caixa — o fluxo de caixa livre de doze meses chega a uns R$ 4 bilhões. Protocolou porque a estrutura do passivo tinha virado uma mola armada, em que o primeiro credor a se mover dispararia todos os outros.` },
  ...
  { p: `A empresa sabe. No release do segundo trimestre, reconhece que certas mercadorias já fazem falta em determinados canais de venda — a prateleira está visivelmente rareando. E, horas depois de o pedido se tornar público, veio à tona que a Casas Bahia começou a estruturar um empréstimo de cerca de R$ 1 bilhão, com fundos e bancos, com o objetivo específico de reforçar o estoque.` },
  ...
  { p: `Os cortes de agosto fecharam 298 das 1.042 lojas que o grupo tinha no fim de 2025, com demissões reportadas em torno de 1,9 mil pela imprensa e estimadas em cerca de 3 mil pela própria companhia. Em junho de 2024, a recuperação extrajudicial já havia reperfilado cerca de R$ 4,1 bilhões e esticado o prazo médio da dívida de 22 para 72 meses. Aquele acordo alcançou bancos e debenturistas. Não alcançou locadores, empregados e fornecedores — que é exatamente o conjunto de credores que o fechamento de lojas em massa produz. Daí o fórum.` },
  ...
  { p: `Nota sobre o horário: o e-mail em questão foi lido numa caixa de entrada italiana, que o exibia como 16h49, hora local. O horário comercial brasileiro corre cinco horas atrás do horário de verão da Europa Central. Reconstruir uma cronologia brasileira a partir de um print europeu é uma pequena armadilha que vale nomear — é a mesma categoria de erro de ler um balanço brasileiro com premissas europeias sobre onde mora o lucro.` },
