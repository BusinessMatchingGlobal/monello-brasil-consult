...
const body: Block[] = [
  ...
  { p: "Os fatos e números vêm de fontes públicas: o Código de Fronteiras Schengen e o Ato de Adesão da Espanha de 1991, as estatísticas de entradas da Frontex 2021–2026, as declarações da Comissão Europeia e do governo espanhol (julho–agosto de 2026), os dados da OCDE, do HCP marroquino e do Banco Mundial, e o texto da iniciativa popular italiana protocolada na Câmara dos Deputados em 30 de junho de 2026." },
  { p: "Business Matching Global — inteligência de mercado e orquestração de negócios no corredor Europa–Brasil. Nosso trabalho se apoia em rigorosa checagem de fatos e dados, porque — como diz a máxima atribuída a W. Edwards Deming, o estatístico que ensinou qualidade à indústria japonesa — sem dados, você é apenas mais uma pessoa com uma opinião. E nós não temos opiniões." },
];
