...
const body: Block[] = [
  ...
  { p: "The numbers in the petition: R$17.3 billion in liabilities, of which roughly R$16.4 billion is owed to quirografário creditors — unsecured creditors, those with no collateral behind their claim, who sit at the back of the queue — plus R$754 million in labour debts and R$154 million owed to micro and small enterprises. When the market opened on Monday, BHIA3 fell as far as R$0.42 intraday and closed at R$0.44, down 33% on the day, on top of a near-80% decline over the year. The auditors had already flagged a material uncertainty about the company's ability to continue as a going concern, which is the accounting profession's most formal way of saying it may not survive the year." },
  { p: "There is a technical detail in the petition that explains its timing better than any of those figures. The group's contracts carry cross-default and acceleration clauses — vencimento antecipado — and the petition itself quantifies the exposure: more than R$10 billion in financial and commercial contracts could come due at once. Worse, if creditor banks retained the guarantees they hold over card and Pix receivables, up to 60% of the company's monthly cash inflow would drain away immediately, making the business unviable on the spot. The filing exists to freeze that cascade before it starts — it asks for a 180-day suspension of enforcement. And the cascade was no longer hypothetical: by the time the petition went in, acceleration notices had already landed, from the Brazilian arms of Hisense Gorenje and Lenovo, from a creditor fund, from the landlord of a logistics property. Which reframes the whole event: the company was not filing because it had stopped generating cash — free cash flow over twelve months ran to some R$4 billion. It filed because the structure of its liabilities had become a loaded spring, where the first creditor to move would trigger all the others. Note the irony buried in that 60% figure: the discount campaign pushes customers toward Pix — the very receivables the banks hold as collateral." },
  ...
  { p: "The company knows it. In the second-quarter report it acknowledges that certain goods are already missing from certain sales channels — and the numbers behind that admission are now public: available inventory fell more than 20% in the quarter, and days of stock on hand dropped from 95 at the end of March to 75 at the end of June. And within hours of the filing becoming public, it emerged that Casas Bahia had begun structuring a loan of around R$1 billion, from funds and banks, for the specific purpose of restocking." },
  { p: "Who is waiting in the creditor queue makes the point concrete. The single largest listed creditor is an insurer — Zurich's Brazilian unit, with R$1.98 billion. Around it stand the banks and funds, and among the top names sit the manufacturers: Samsung with some R$938 million, Whirlpool with R$801 million, Electrolux with R$700 million, LG with R$624 million, Motorola with R$619 million — down to Apple, with R$183 million. The nineteen largest creditors alone account for 70% of the liabilities. And the R$17.3 billion inside the process is not even the whole picture: nearly R$11 billion more sits outside it as extraconcursal claims — mostly banks holding fiduciary title over card receivables, leases and FX advances, which the recovery does not touch. Banco Digio, the group's biggest bank creditor at R$3.28 billion, has R$2.62 billion of that parked in the protected layer. The queue you can see is long; but the best-placed claims are the ones that never have to join it." },
  { p: "And here the promotional email closes its own loop: the refrigerator headlining it was a Brastemp — a Whirlpool brand. The fridge being discounted for instant cash and the R$800 million receivable frozen in court belong to the same supplier. That is takeaway number two of this article, photographed." },
  ...
  { p: "It is also the last door left. Over the preceding months the company tried an equity offering — the market window shut in April — and an international funding round with a global bank as anchor, which stalled. The conversations now are with Bradesco and Banco do Brasil; the company puts its immediate need at roughly R$400 million of additional stock; and in parallel it is phoning its Chinese manufacturers and, tellingly, the credit insurers who underwrite suppliers' lines to the electronics industry. That last call is the one European exporters should notice: whether the shelf refills does not depend only on lenders. It depends on whether an insurer keeps covering your invoice." },
  ...
  { p: "The August cuts closed 298 of the 1,042 stores the group had at the end of 2025, with dismissals reported at around 1,900 and put by the company itself at roughly 3,000, out of a workforce of just over 30,000. In April 2024 it had already homologated an out-of-court restructuring that reprofiled about R$4.8 billion and stretched the average maturity of its debt from 22 to 72 months. That deal reached banks and bondholders. It did not reach landlords, employees, or suppliers — which is precisely the set of creditors that mass store closures create. Hence the courthouse." },
  { p: "Nor is this one company's story. The same week, furniture chain Marabraz filed for judicial recovery too, and Brazil's central-bank-tracked tally now shows large retailers restructuring more than R$68 billion in debt over two and a half years — from Americanas' R$43 billion fraud-triggered collapse in 2023 through Grupo Pão de Açúcar, Tok&Stok, Casa & Vídeo, Dia and Polishop. The common thread across fraud and no-fraud cases alike: business models built on consumer credit, working capital and inventory financing, hit by a policy rate that went from 2% to 15% in five years. Casas Bahia is not the exception. It is the largest data point." },
  { h: "The control group" },
