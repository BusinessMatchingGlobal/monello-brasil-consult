...
const body: Block[] = [
  ...
  { p: "Business Matching Global — analisi di mercato e coordinamento commerciale sul corridoio Europa–Brasile. Il nostro lavoro si fonda su un rigoroso controllo di fatti e dati, perché — come recita la massima attribuita a W. Edwards Deming, lo statistico che insegnò la qualità all'industria giapponese — senza dati sei solo un'altra persona con un'opinione. E noi di opinioni non ne abbiamo." },
];
