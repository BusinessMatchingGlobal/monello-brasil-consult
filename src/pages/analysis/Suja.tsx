...
const content = {
  ...
  pt: {
    ...
    body: [
      ...
      { p: "Em julho de 2026, auditores-fiscais do trabalho em Fortaleza libertaram uma mulher de 62 anos mantida pela mesma família ao longo de três gerações — desde 1971 — como trabalhadora doméstica não remunerada. Sem salário, sem férias, sem alfabetização, sem contato com o mundo exterior. Sua mãe havia servido a mesma família antes dela. O caso veio à tona da única forma em que esses casos vêm à tona no Brasil: uma denúncia anônima." },
      { p: "A mídia europeia lerá isso como sempre lê o Brasil: como confirmação de uma vergonha distante e tropical." },
      { p: "Seis semanas antes, no coração de Milão." },
      { p: "Em maio de 2026, a Procuradoria colocou a Caddell Construction — o gigante do Alabama que constrói o novo Consulado Geral dos Estados Unidos na Piazzale Accursio, contrato de US$ 200 milhões — sob controle judicial de urgência por caporalato. A investigação descreve o que os próprios magistrados chamam de \"para-escravidão\": centenas de trabalhadores indianos recrutados por uma agência em Nova Delhi, cada um pagando 5.000 euros pelo privilégio; salários reais de 1 a 2 euros por hora ocultos por um duplo contracheque entre Índia e Itália; doze horas por dia, seis dias por semana, sem descanso, sem licença médica. No pico, 450–500 trabalhadores. Dois gestores estão em prisão preventiva — um preso no aeroporto de Bergamo tentando deixar o país. O juiz de instrução escreveu que a exploração era \"costume da empresa.\" A Procuradoria agora pede vistos humanitários para pelo menos cem trabalhadores que cooperam com a investigação." },
      { p: "Mesmo crime. Mesmo semestre. Dois hemisférios. A história não é que o Brasil tem um problema de escravidão e a Europa não. A história é o que acontece depois que o crime é descoberto — porque aí os dois sistemas divergem completamente." },
      { h: "Brasil: a arquitetura que a Europa não sabe que precisa" },
      { p: "Os dados brasileiros de fiscalização de 2025, divulgados pelo Ministério do Trabalho em janeiro de 2026, mostram um sistema em movimento:" },
      { p: "2.772 trabalhadores resgatados em 1.594 operações de fiscalização — alta de 38% sobre 2024, terceiro maior número anual desde o início das fiscalizações sistemáticas em 1995. Mais de 68.000 pessoas resgatadas em trinta anos." },
      { p: "Pela primeira vez, os resgates urbanos (68%) superaram os rurais. O estereótipo do trabalho escravo como fenômeno de fazenda remota é hoje estatisticamente obsoleto." },
      { p: "O trabalho doméstico tornou-se prioridade declarada de fiscalização: 122 inspeções direcionadas em 2025 contra 22 em 2024 — aumento de cinco vezes." },
      { p: "83% dos resgatados autodeclaram-se pretos ou pardos. A continuidade colonial não é retórica; é o perfil demográfico da carga de casos." },
      { p: "No centro dessa arquitetura está um instrumento sem equivalente na Europa: o Cadastro de Empregadores — a \"lista suja.\" Um registro público, gratuito, atualizado semestralmente, de empregadores — empresas e pessoas físicas — com condenações administrativas definitivas por submeter trabalhadores a condições análogas à escravidão. Os nomes permanecem publicados por dois anos. O STF confirmou sua constitucionalidade em 2020 (ADPF 509) como transparência ativa, não sanção. Bancos e varejistas brasileiros já a usam em análise de crédito e de fornecedores." },
      { p: "A atualização de abril de 2026 mostra para onde vai a fiscalização: das 169 novas inclusões, a maior categoria foi serviços domésticos (23 inclusões) — à frente da pecuária e do café. A mesma atualização incluiu a BYD, após um TAC de R$ 40 milhões com o MPT sobre as condições no canteiro da fábrica na Bahia. O mecanismo alcança tanto famílias em Fortaleza quanto os maiores players industriais do planeta." },
      { p: "O sistema tem um gargalo constitucional — o artigo 5º torna o domicílio inviolável, e por isso todo resgate doméstico começa por uma denúncia anônima, e por isso o recorde de 4.516 denúncias de 2025 pesa tanto quanto as fiscalizações. E tem um risco de governança que precisa ser nomeado com honestidade: intervenções ministeriais que passaram por cima dos auditores em inclusões na lista suja — o caso JBS Aves acima de tudo — provocaram protestos do corpo de fiscalização no início de 2026. O instrumento é potente; sua independência é contestada. Contrapartes sérias monitoram ambos." },
      { h: "Itália: remediação sem registro" },
      { p: "Olhe agora a resposta italiana — porque a Itália tem um instrumento, e é um que falta ao Brasil." },
      { p: "Além do marco penal anti-caporalato (Lei 199/2016, art. 603-bis do Código Penal), a Procuradoria de Milão foi pioneira em algo mais cirúrgico: colocar empresas saudáveis e não indiciadas sob administração judicial — medida preventiva emprestada do código antimáfia (art. 34, d.lgs. 159/2011) — por facilitar culposamente a exploração ao longo das suas cadeias de subcontratação. O setor da moda mostra o modelo em escala. Alviero Martini, Armani Operations, Manufactures Dior, Valentino, Loro Piana, Tod's: casas de luxo cujas cadeias terminavam em oficinas onde um casaco de caxemira vendido a 3.000 euros era montado por cerca de 100 euros. Em fevereiro de 2026, a Procuradoria de Prato estendeu o modelo para além de Milão com a Piazza Italia — trabalhadores abaixo de 4 euros por hora, sete dias por semana, margens estimadas em 300% sobre o custo de produção. Em dezembro de 2025, mais treze marcas figuravam nos autos milaneses. O caso Caddell na Piazzale Accursio pertence à mesma filosofia: subir a responsabilidade na cadeia, até o tomador." },
      { p: "E o instrumento corrige. A Loro Piana entrou em administração judicial em julho de 2025 e saiu em abril de 2026, com o tribunal chamando de \"virtuosa\" a reforma da cadeia — governança reforçada, auditorias independentes, fornecedores não conformes rescindidos. Nove meses do sequestro ao benchmark." },
      { p: "Mas aqui está a assimetria: quando a remediação termina, não há registro. Nenhuma lista pública onde um banco, um contratante principal ou um comprador possa checar se uma empresa foi julgada responsável, ou facilitou culposamente, a exploração do trabalho. O único instrumento público permanente da Itália é a Rete del lavoro agricolo di qualità — uma white list voluntária, limitada à agricultura." },
      { p: "Leia o contraste com precisão. O Brasil publica os nomes dos culpados, duas vezes por ano, em todos os setores, incluindo famílias, validado pelo STF — instrumento de memória que informa todo o mercado mas não corrige ninguém. Milão sequestra e reabilita um tomador por vez — instrumento de remediação que corrige a empresa mas não deixa rastro consultável para o mercado. Dois instrumentos sofisticados, perfeitamente complementares. Nenhuma das jurisdições adotou o da outra." },
      { p: "E a mecânica da exploração era quase idêntica nos dois casos: dívida de recrutamento (5.000 euros em Nova Delhi; aliciamento no Maranhão), dependência habitacional (residências da empresa fora de Milão; alojamentos em canteiros brasileiros), vulnerabilidade linguística, ocultação salarial. O que o artigo 149 do Código Penal brasileiro chama de \"condição análoga à escravidão,\" a Procuradoria de Milão chama de \"para-schiavismo.\" Mesmo fenômeno. Arquitetura institucional de resposta diferente." },
      { h: "A tradução para o negócio" },
      { p: "Com a CSDDD alterada (pós-Omnibus, Diretiva 2026/470), a due diligence obrigatória da UE aplica-se agora apenas aos maiores grupos — 5.000+ empregados, 1,5 bilhão de euros de faturamento, compliance a partir de 2029. Mas esses grupos compram café, carne, minerais e manufaturados brasileiros, e a diretiva lista explicitamente o nível de fiscalização em uma dada geografia entre os fatores de risco a ponderar. Suas obrigações cascatearão contratualmente sobre cada importador europeu de médio porte em suas cadeias." },
      { p: "Milão acaba de demonstrar que a geografia do risco de trabalho forçado inclui a Lombardia. O Brasil demonstra, duas vezes por ano, como se parece um instrumento de transparência para esse risco." },
      { p: "A lista suja — pública, gratuita, atualizada a cada seis meses — é o instrumento de screening de cadeia de suprimentos mais barato disponível para o mercado brasileiro. Em quinze anos de trabalho nos corredores, ainda não conheci um importador europeu que a tenha consultado antes de assinar um contrato de fornecimento." },
      { p: "Um canteiro do governo dos EUA em Milão operou com trabalho a 2 euros por hora por dois anos antes que alguém interviesse. O Brasil publica um registro exatamente dessa conduta, duas vezes por ano, a custo zero de consulta. Com qual dos dois sistemas o seu departamento de compliance preferiria trabalhar — e por que a Europa ainda não tem um?" },
      { h: "Fontes" },
      { p: "MTE/SIT, Balanço 2025 das ações de combate ao trabalho em condições análogas à escravidão (28 de janeiro de 2026)" },
      ...
      { p: "Procuradoria de Milão, decreto de controle judicial de urgência, Caddell Construction Co. LLC (26 de maio de 2026); cobertura: Il Sole 24 Ore, Il Fatto Quotidiano, Open, MilanoToday (maio-julho de 2026)" },
      { p: "Lei 199/2016; art. 603-bis do C.P.; art. 27-quinquies do TUI (segundo emprego); art. 34 do d.lgs. 159/2011 (administração judicial)" },
      { p: "Tribunal de Milão, administrações judiciais da cadeia da moda (Alviero Martini 2024; Armani Operations 2024; Manufactures Dior 2024; Valentino 2025; Loro Piana jul. 2025, revogação abr. 2026; Tod's); Tribunal de Prato, Piazza Italia (fev. 2026) — cobertura: Il Fatto Quotidiano, Il Post, Pambianconews, Sky TG24" },
      { p: "InPACTO, Balanço do combate ao trabalho escravo 2025" },
      { p: "Diretiva (UE) 2026/470 (Omnibus I), Jornal Oficial, 26 de fevereiro de 2026" },
      { p: "Código Penal, art. 149; Constituição Federal, art. 5º, XI; LC 150/2015" },
      { p: "Nota importante: os procedimentos italianos citados estão em andamento ou foram concluídos com medidas de prevenção; para as pessoas físicas investigadas vale a presunção de inocência." },
    ],
  },
} as const;
