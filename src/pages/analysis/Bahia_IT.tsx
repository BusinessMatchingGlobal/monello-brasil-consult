...
const body: Block[] = [
  ...
  { p: `I numeri dell'istanza: R$17,3 miliardi di passività (circa 2,7 miliardi di euro), di cui approssimativamente R$16,4 miliardi verso creditori quirografários — i chirografari, quelli senza garanzie reali a tutela del proprio credito, in fondo alla fila — più R$754 milioni di debiti di lavoro e R$154 milioni verso micro e piccole imprese. All'apertura di lunedì il titolo BHIA3 è sceso fino a R$0,42 intraday e ha chiuso a R$0,44, -33% in giornata, sopra un calo di quasi l'80% da inizio anno. I revisori avevano già segnalato una incertezza rilevante sulla continuità aziendale — il modo più formale che la professione contabile conosca per dire che l'azienda potrebbe non arrivare a fine anno.` },
  { p: `C'è un dettaglio tecnico nel ricorso che spiega il tempismo meglio di qualunque cifra. I contratti del gruppo contengono clausole di cross-default e di decadenza dal beneficio del termine — il vencimento antecipado — e il ricorso stesso quantifica l'esposizione: più di R$10 miliardi di contratti finanziari e commerciali potrebbero diventare esigibili in una volta sola. Peggio: se le banche creditrici trattenessero le garanzie che detengono sui crediti da carte e Pix, fino al 60% dell'entrata di cassa mensile verrebbe drenato immediatamente, e l'azienda si fermerebbe all'istante — non in perdita: senza il denaro per pagare stipendi, fornitori e affitti, con i negozi ancora pieni di merce. La domanda al tribunale esiste per congelare quella cascata prima che parta — chiede la sospensione delle esecuzioni per 180 giorni. E la cascata non era più ipotetica: quando l'istanza è stata depositata, le notifiche di decadenza dal termine erano già arrivate — dai bracci brasiliani di Hisense Gorenje e Lenovo, da un fondo creditore, dal locatore di un immobile logistico. Il che riquadra l'intero evento: l'azienda non ha depositato perché aveva smesso di generare cassa — il flusso di cassa libero degli ultimi dodici mesi arriva a circa R$4 miliardi. Ha depositato perché la struttura del passivo era diventata una molla caricata, dove il primo creditore a muoversi avrebbe fatto scattare tutti gli altri. E notate l'ironia sepolta in quel 60%: la campagna sconti spinge i clienti verso il Pix — esattamente i crediti che le banche tengono in garanzia.` },
  ...
  { p: `L'azienda lo sa. Nella relazione del secondo trimestre riconosce che certe merci già mancano in certi canali di vendita — e i numeri dietro quell'ammissione ora sono pubblici: gli stock disponibili sono calati di oltre il 20% nel trimestre, e i giorni di magazzino sono scesi da 95 a fine marzo a 75 a fine giugno. E a poche ore dalla pubblicità del ricorso è emerso che Casas Bahia ha cominciato a strutturare un prestito di circa R$1 miliardo, presso fondi e banche, con lo scopo specifico di rifornire lo stock.` },
  { p: `Chi aspetta nella fila dei creditori rende il punto concreto. Il maggior creditore singolo elencato è un assicuratore — l'unità brasiliana di Zurich, con R$1,98 miliardi. Intorno stanno banche e fondi, e tra i primi nomi siedono i produttori: Samsung con circa R$938 milioni, Whirlpool con R$801, Electrolux con R$700, LG con R$624, Motorola con R$619 — giù fino ad Apple, con R$183 milioni. I diciannove maggiori creditori da soli fanno il 70% del passivo. E i R$17,3 miliardi dentro la procedura non sono nemmeno il quadro intero: quasi R$11 miliardi in più stanno fuori, come crediti extraconcursais — soprattutto banche con proprietà fiduciaria su crediti da carte, leasing e anticipi su cambi, che la recuperação non tocca. Il Banco Digio, il maggior creditore bancario del gruppo con R$3,28 miliardi, ne ha R$2,62 parcheggiati in quello strato protetto. La fila che si vede è lunga; ma i crediti messi meglio sono quelli che nella fila non devono nemmeno entrare.` },
  { p: `E qui l'email promozionale chiude il proprio cerchio: il frigorifero in vetrina era un Brastemp — un marchio Whirlpool. Il frigo scontato per il contante istantaneo e il credito da R$800 milioni congelato in tribunale appartengono allo stesso fornitore. È il punto due di questo articolo, fotografato.` },
  ...
  { p: `Ed è anche l'ultima porta rimasta. Nei mesi precedenti l'azienda aveva tentato un'offerta di azioni — la finestra di mercato si è chiusa ad aprile — e una raccolta internazionale con una grande banca globale come âncora, arenatasi. I colloqui ora sono con Bradesco e Banco do Brasil; l'azienda stima il fabbisogno immediato in circa R$400 milioni di stock aggiuntivo; e in parallelo sta telefonando ai produttori cinesi e, dettaglio rivelatore, alle assicurazioni del credito che garantiscono le linee dei fornitori all'industria elettronica. È la telefonata che l'esportatore europeo dovrebbe notare: se lo scaffale si riempie non dipende solo dai finanziatori. Dipende dal fatto che un assicuratore continui a coprire la tua fattura.` },
  ...
  { p: `I tagli di agosto hanno chiuso 298 dei 1.042 negozi che il gruppo aveva a fine 2025, con licenziamenti riportati intorno a 1.900 dalla stampa e stimati in circa 3.000 dall'azienda stessa, su poco più di 30.000 dipendenti. Ad aprile 2024 aveva già omologato una ristrutturazione stragiudiziale che riprofilò circa R$4,8 miliardi e allungò la scadenza media del debito da 22 a 72 mesi. Quell'accordo raggiunse banche e obbligazionisti. Non raggiunse locatori, dipendenti e fornitori — che è esattamente l'insieme di creditori che le chiusure di massa producono. Da qui il tribunale.` },
  { p: `E non è nemmeno la storia di una sola azienda. Nella stessa settimana ha chiesto la recuperação judicial anche la catena di mobili Marabraz, e il conteggio dei grandi retailer brasiliani arriva a più di R$68 miliardi di debiti ristrutturati in due anni e mezzo — dal crollo di Americanas nel 2023, innescato da una frode da R$43 miliardi, passando per Grupo Pão de Açúcar, Tok&Stok, Casa & Vídeo, Dia e Polishop. Il filo comune, con o senza frode: modelli costruiti su credito al consumo, capitale circolante e finanziamento degli stocks, colpiti da un tasso di riferimento passato dal 2% al 15% in cinque anni. Casas Bahia non è l'eccezione. È il caso più grande della serie.` },
