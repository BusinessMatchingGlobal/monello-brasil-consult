      ...
      <div className="container max-w-3xl py-16 md:py-24">
        ...
        <article className="prose-invert">
          ...
          <p className="text-xs text-foreground/70 mb-10 tabular-nums">
            {`published 13-08-2026 — updated 15-08-2026`}
          </p>
