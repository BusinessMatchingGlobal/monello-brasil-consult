...
const DATA: Record<AnyLang, { heading: string; items: Item[] }> = {
  ...
  es: {
    ...
    items: [
      { title: "Quién emite los pasajes.", body: ["Todos los pasajes son emitidos por una agencia de viajes debidamente habilitada en Italia, propiedad de CAVALLINODIECI S.r.l., que opera con la marca Calliphora Travel desde 2004."] },
      ...
      { title: "Si paga desde Sudamérica.", body: [
        ...
        "Es solo una sugerencia práctica: la relación con la plataforma es exclusivamente suya, y recomendamos comparar condiciones antes de decidir.",
      ] },
      { title: "Emisión.", body: ["El pasaje se emite una vez acreditados efectivamente los fondos y se envía por correo electrónico. Una transferencia SEPA suele acreditarse el mismo día o el día hábil siguiente. Confirmada la oferta, realice el pago cuanto antes, teniendo en cuenta fines de semana y feriados."] },
      { title: "Asistencia durante el viaje, siempre incluida en el precio.", body: ["Desde la emisión hasta el regreso lo acompañamos por correo y WhatsApp, sin costo adicional. Es una asistencia proactiva: ante cancelaciones, demoras o reprotecciones actuamos nosotros, sin esperar a que nos escriba desde el aeropuerto."] },
    ],
  },
};
