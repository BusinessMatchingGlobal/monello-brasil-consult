...
export const translations = {
  en: {
    nav: { home: "Home", services: "Services", how: "How it works", method: "Our method", about: "Who we are", travel: "Business Travel", news: "Ebook", analysis: "Analysis", analysisAll: "All articles →", contact: "Contact" },
    hero: {
  ...
  it: {
    nav: { home: "Home", services: "Servizi", how: "Come funziona", method: "Il nostro metodo", about: "Chi siamo", travel: "Business Travel", news: "Ebook", analysis: "Analisi", analysisAll: "Tutti gli articoli →", contact: "Contatti" },
    hero: {
  ...
  pt: {
    nav: { home: "Home", services: "Serviços", how: "Como funciona", method: "Nosso método", about: "Quem somos", travel: "Business Travel", news: "Ebook", analysis: "Análises", analysisAll: "Todos os artigos →", contact: "Contato" },
    hero: {
