...
export const translations = {
  en: {
    ...
    problem: {
      title: "The market is not the problem. The unchecked assumption is.",
  ...
  it: {
    ...
    problem: {
      title: "Il mercato non è il problema. Lo è l'ipotesi non verificata.",
      body: "Gli errori in Brasile non si fanno al tavolo della trattativa. Si fanno prima, su un'ipotesi che nessuno ha verificato: una norma, un'imposta, la posizione reale di un distributore. Noi la verifichiamo, per iscritto, con la fonte allegata.",
      items: [
  ...
  pt: {
    ...
    problem: {
      title: "O mercado não é o problema. A suposição não verificada é.",
