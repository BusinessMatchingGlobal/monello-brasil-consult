...
export const translations = {
  en: {
    nav: { services: "Services", how: "How it works", about: "Who we are", contact: "Contact" },
    hero: {
  ...
  it: {
    nav: { services: "Servizi", how: "Come funziona", about: "Chi siamo", contact: "Contatti" },
    hero: {
  ...
  pt: {
    nav: { services: "Serviços", how: "Como funciona", about: "Quem somos", contact: "Contato" },
    hero: {
